...
const PostsContent = ({post,isLiked,onShare,onComment,onLike}) => {
    ...
    const userPlaceholder = post?.user?.username ?.split(" ").map((name) => name[0].toUpperCase()).join("");
 ...
 >
    <Card>
        <CardContent className="sm:p-6 p-1 dark:text-white ">
            ...
            <div >
             ...
             <div className='flex justify-between items-center mb-4 max-sm:px-2'>
