...
const Header = () => {
  ...
  return (
    <header className="bg-white dark:bg-[rgb(36,37,38)] text-foreground shadow-md h-14 fixed top-0 left-0 right-0 z-50 ">
      <div className="mx-auto flex justify-between items-center p-2 px-3">
                        ...
                        >
                          <Avatar className="h-10 w-10">
                            {user?.profilePicture ? (
                              ...
                              <AvatarFallback className="dark:bg-gray-200 dark:text-gray-800">{userPlaceholder}</AvatarFallback>
                            )}
                          </Avatar>
            ...
            <DropdownMenuTrigger asChild>
              ...
              <Avatar className="h-10 w-10 mr-2">
                      {user?.profilePicture ? (
                        ...
                        <AvatarFallback className="dark:bg-gray-300 dark:text-gray-800 bg-gray-300">
                          {userPlaceholder}
                        </AvatarFallback>
                      )}
                    </Avatar>
