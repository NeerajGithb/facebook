      ...
      <CardContent className="p-4">
        <div className="flex space-x-4">
          ...
          <Dialog open={isPostFormOpen} onOpenChange={setIsPostFormOpen}>
            ...
            <DialogContent className="sm:max-w-[525px] sm:max-h-[80vh] max-w-[90vw] overflow-y-auto">
              <DialogHeader>
              ...
              <AnimatePresence>
                {(showImageUpload || filePreview) && (
                  <motion.div
                    ...
                    className="relative mt-4 border-2 border-dashed  border-gray-300 sm:rounded-lg p-8 flex  flex-col items-center justify-center "
                  >
                    <Button
                      variant="ghost"
                      size="icon"
              ...
              <div className="bg-gray-200 dark:bg-muted p-4 sm:rounded-lg mt-4 ">
